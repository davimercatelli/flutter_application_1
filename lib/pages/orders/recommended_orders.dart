              ...
              bottom: PreferredSize(
                  ...
                  child: Container(
                    ...
                    padding: EdgeInsets.only(
                        top: Dimensions.radius15, bottom: Dimensions.radius15),
                    ...
                    child: Center(
                      child:
                          BigText(size: Dimensions.font20, text: product.name!),
                    ),
                  )),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: AppIcon(
                          iconSize: Dimensions.iconSize24, icon: Icons.remove),
                    ),
                    ...
                    GestureDetector(
                      ...
                      child: AppIcon(
                          iconSize: Dimensions.iconSize24, icon: Icons.add),
                    )
                  ],
                ),
              ),
